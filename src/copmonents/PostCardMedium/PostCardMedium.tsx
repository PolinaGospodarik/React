            ...
            <div>
                <div className="medium-card">
                    <div className="medium-card__content">
                        ...
                        <h2 className="medium-card__title">{title}</h2>
                    </div>
                    <div className="medium-card__icons">
                        <div className="medium-card__icons-left">
                            <button><FontAwesomeIcon icon={faThumbsUp} className="medium-card__icon-like"/></button>
                            <button><FontAwesomeIcon icon={faThumbsDown} className="medium-card__icon-dislike"/></button>
                        </div>
                        <div className="medium-card__icons-right">
                            <button><FontAwesomeIcon icon={faBookmark} className="medium-card__icon-bookmark"/></button>
                            <button><FontAwesomeIcon icon={faEllipsis} className="medium-card__icon-menu"/></button>
                        </div>
                    </div>
                </div>
            </div>
